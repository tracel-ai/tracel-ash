...
pub type PFN_vkGetGpaSessionStatusAMD =
    unsafe extern "system" fn(device: ash::vk::Device, gpa_session: GpaSessionAMD) -> Result;
#[allow(non_camel_case_types)]
...
pub type PFN_vkLatencySleepLegacyNV =
    unsafe extern "system" fn(device: ash::vk::Device, signal_semaphore: Semaphore, value: u64);
#[allow(non_camel_case_types)]
pub type PFN_vkSetLatencyMarkerLegacyNV =
    unsafe extern "system" fn(device: ash::vk::Device, frame_id: u64, marker: u32);
#[allow(non_camel_case_types)]
pub type PFN_vkGetLatencyTimingsLegacyNV =
    unsafe extern "system" fn(device: ash::vk::Device, p_timings: *mut c_void);
#[allow(non_camel_case_types)]
...
pub type PFN_vkGetSleepStatusLegacyNV =
    unsafe extern "system" fn(device: ash::vk::Device, p_low_latency_mode: *mut Bool32);
#[allow(non_camel_case_types)]
pub type PFN_vkShutdownLatencyDeviceLegacyNV = unsafe extern "system" fn(device: ash::vk::Device);
